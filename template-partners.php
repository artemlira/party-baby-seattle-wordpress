...
get_header(); ?>
  ...
  <div class="page partners-page">
    <section class="partners-hero wow fadeIn">
      <div class="container"
           style="background: url(<?php the_field('partners_page_hero_background_url') ?>); background-size: cover;">
    ...
    <section class="partners-benefits">
      <div class="container">
        <?php $count = 2;
        if (have_rows('partners_page_benefits_items')) : ?>
      ...
      <div class="container">
        <div class="flex">
          <div class="col-50 wow fadeIn" data-wow-delay="0.2s">
            <img class="hide-mobile" src="<?php echo get_template_directory_uri() ?>/img/partners.svg"
                 alt="<?php bloginfo('name'); ?>">
            <img class="hide-desktop " src="<?php echo get_template_directory_uri() ?>/img/partners2.svg"
                 alt="<?php bloginfo('name'); ?>">
          </div>
          <div class="col-50">
              ...
              if ($videos) :
                foreach ($videos as $video) :
                  ...
                  <div class="video-container">
                    <video src="<?php echo esc_url($video_url); ?>" loop muted playsinline data-wf-ignore="true"
                    ...
                    <div class="action">
                      <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M17.4096 7.35309C17.8899 7.60849 18.2916 7.98976 18.5718 8.45604C18.852 8.92232 19 9.45604 19 10C19 10.544 18.852 11.0777 18.5718 11.544C18.2916 12.0103 17.8899 12.3915 17.4096 12.6469L4.59715 19.6137C2.53408 20.7367 0 19.2767 0 16.9678V3.03322C0 0.723286 2.53408 -0.735671 4.59715 0.385296L17.4096 7.35309Z"
                            fill="white"/>
                      </svg>
                    </div>
                  </div>
      ...
      <div class="home-gallery">
        ...
        if ($gallery_images) :
          ...
          foreach ($gallery_images as $index => $image) :
            ...
            ?>
            <div class="item wow fadeIn <?php if (empty($image['caption'])) : ?>no-caption<?php endif; ?>"
                 data-wow-delay="0.<?php echo $count ?>s">
              <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>"/>
              <?php if (!empty($image['url'])) : ?>
                <div class="desc" src="<?php echo esc_url($image['url']); ?>"
    ...
    <section class="phone-block wow fadeIn">
      <div class="container">
        <img class="wow fadeIn" data-wow-delay="0.1s" src="<?php echo get_template_directory_uri() ?>/img/inst.png"
             alt="Photo"/>
        <div class="content">
          <h2 class="title wow fadeIn" data-wow-delay="0.2s">Add a Customized IG Reel to Capture Every Moment of Your
            Event!</h2>
          <?php $button = get_field('instagram_page_phone_block_button') ?>
          <a href="<?php echo esc_url(home_url('/instagram-reels-add-on/')); ?>" class="btn wow fadeIn"
             data-wow-delay="0.4s">Learn More About Our IG Reel Add-on</a>
        </div>
      </div>
    </section>
    <section class="insta-counter wow fadeIn">
      <div class="container">
        <div class="flex">
          <div class="col-50 wow fadeIn" data-wow-delay="0.2s">
            <div class="counter num title" data-start="3500000" data-end="4000000">3,500,000</div>
            <div class="text">Total Views</div>
          </div>
          <div class="col-50 wow fadeIn" data-wow-delay="0.4s">
            <div class="counter num title" data-start="300" data-end="500">400</div>
